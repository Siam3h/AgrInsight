<template>
  <div
    class="relative isolate overflow-hidden bg-gradient-to-b from-green-500 to-green-700 text-white py-24 sm:py-32"
  >
    <img
    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="mx-auto max-w-2xl lg:mx-0">
        ...
        <p class="mt-6 text-lg leading-8 text-gray-300">
          ...
          productivity. From recommending the best crops to predicting yields
          and offering the best farming practices, we empower farmers to make
...
const links = [
  ...
  { name: "Check Recommended Crop", href: "/about/recommend/" },
