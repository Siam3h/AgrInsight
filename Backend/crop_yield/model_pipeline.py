...
class CropYieldModel:
    ...
    def prepare_data(self):
        ...
        df_yield = df_yield.drop(['Year Code', 'Element','Year Code','Area Code','Domain Code', 'Domain','Unit','Item Code'], axis=1)
        df_yield = df_yield.dropna()
        
        df_rain = pd.read_csv(r'crop_yield/data/rainfall.csv')
